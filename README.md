...
🚀 Usage Instructions
Open the Power BI dashboard file expense_variance_dashboard.pbix
Load budget_actual_monthly_agg.csv (and budget_actual_cleaned.csv for region/payment-method views) if required
Navigate through dashboard pages
Apply filters using: Department, Category, Region, Month
Analyze budget variance and anomaly trends
